...
# Basic webpage setup
st.set_page_config(
   page_title="Course Recommender System - Saurav Sharma",
   layout="wide",
...
st.sidebar.subheader('3. Train the selected Model:')
training_button = False
training_button = st.sidebar.button("Train")
...
st.sidebar.subheader('4. Generate Recommendations:')
